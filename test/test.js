var behavior = jQuery.Behavior();

var monkeyPatching = ("on one off trigger triggerHandler hover bind unbind delegate undelegate" +
...
jQuery.each(monkeyPatching, function(i, name) {
    jQuery.fn[name + '_orig'] = jQuery.fn[name];
    jQuery.fn[name] = function () {
        var wrap = behavior(this);
        var result = wrap[name].apply(wrap, arguments);
        if (name === 'triggerHandler') return result;
        else return this;
    };
});
